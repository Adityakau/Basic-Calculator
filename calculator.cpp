...
int main ()
{
    ...
    char op, choice[10];
    cout<<"Add the op of your choice in between the two numbers as given below"<<endl;
    cout<<"Type + to add, - to subtract, * to multiply, / to divide, \
    ...
    // CREATING THE MEMORY
    cout<<"\nType 'mem' to insert the number into memory, or 'clr' to clear memory\n";
    cin>>choice;
    if (!strcmp(choice,"mem")) memory=r; // INSERT THE MEMORY
    else if (!strcmp(choice,"clr")) memory=0; // CLEAR THE MEMORY
